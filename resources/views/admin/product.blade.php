                ...
                <tr>
                   <td>{{$k1+1}}.</td>
                    <td class="changestatus">
                  	<span class="btn badge bg-yellow @if ($one->istop!=1) hide @endif" data-status="1" data-id="{{$one->id}}">推荐</span>
                   <span class="btn badge bg-defult @if ($one->istop==1) hide @endif" data-status="2" data-id="{{$one->id}}">不推荐</span>
                  </td>
