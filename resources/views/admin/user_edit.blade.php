      ...
      <div class="col-sm-12 col-xs-12">
        <div class="box box-info">
            ...
            <form class="form-horizontal" id="checksubmit" action="" method="post">
              <div class="box-body">
                <div class="form-group @if ($errors->first('username')||$errors->first('data_exists')) has-error @endif">
                  ...
                  <div class="col-sm-10">
					...
					@endif
					@if ($errors->first('data_exists'))
                     <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$errors->first('data_exists')}}</label>
					@endif
                  </div>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="password" name="password" value="@if ($list) {{$list->password}} @endif" disabled class="form-control"  placeholder="旧密码">
                  </div>
                </div>
            ...
            <form class="form-horizontal" id="checksubmit" action="" method="post">
              <div class="box-body">
                <div class="form-group @if ($errors->first('username')||$errors->first('data_exists')) has-error @endif">
                  <label for="inputEmail3" class="col-sm-2 control-label">账号名称</label>
                  <div class="col-sm-10">
                    <input type="text" name="username" value="@if(old('username')!=''){{old('username')}}@endif" class="form-control"  placeholder="用户名">
                     @if ($errors->first('username'))
                     <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$errors->first('username')}}</label>
					@endif
					@if ($errors->first('data_exists'))
              ...
              <div class="form-group @if ($errors->first('newpassword')) has-error @endif">
                  ...
                  <div class="col-sm-10 check-pwd">
                  	<input type="password" name="newpassword" value="{{ old('newpassword') }}" class="form-control"  placeholder="密码" onkeyup="checkpwdconfirm()">
                  	 @if ($errors->first('newpassword'))
                     <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$errors->first('newpassword')}}</label>
					@endif
                  </div>
             ...
             <div class="form-group @if ($errors->first('newpassword2')) has-error @endif">
                  ...
                  <div class="col-sm-10 check-pwd-confirm">
                  	<div class="input-group"><input type="password" class="form-control"  placeholder="确认密码" onkeyup="checkpwdconfirm()">
                    <span class="input-group-addon"><i class="fa msg"></i></span></div>
                     @if ($errors->first('newpassword2'))
                     <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$errors->first('newpassword2')}}</label>
					@endif
