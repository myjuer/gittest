...
function() {
	...
	z = L.DOM,
	B = function(e) {
		return e.style.marginLeft && e.style.marginRight && e.style.marginLeft === e.style.marginRight ? _(e.style.marginLeft) : ""
	},
	H = function(e) {
		return e.style.marginTop && e.style.marginBottom && e.style.marginTop === e.style.marginBottom ? _(e.style.marginTop) : ""
	},
	F = function(e) {
	...
	$ = function(e) {
		var t, n, r, i;
		V(e) ? (i = (r = e).parentNode, z.insertAfter(r, i), z.remove(i)) : (t = e, n = z.create("figure", {
			"class": "image"
		}), z.insertAfter(n, t), n.appendChild(t), n.appendChild(z.create("figcaption", {
			contentEditable: !0
		},
	...
	ae = function(e, t, n) {
		...
		ie(n, r, t, "class", G),
		ie(n, r, t, "style", oe(function(e, t) {
			return G(e, "style", t)
		},
		e)),
	...
	de = function(t, e) {
		var n = function(e, t) {
			...
			if (ae(e, D.merge(t, {
				caption: !1
			}), n), G(n, "alt", t.alt), t.caption) {
				var r = z.create("figure", {
					"class": "image"
				});
				return r.appendChild(n),
				r.appendChild(z.create("figcaption", {
					contentEditable: !0
				},
				"Caption")),
	...
	fe = function(e, t) {
		...
		function(t, e) {
			...
			e, r), n = r, t.dom.setAttrib(n, "src", n.getAttribute("src")), te(r.parentNode)) {
				var i = r.parentNode;
				ce(t, i),
				t.selection.select(r.parentNode)
			} else t.selection.select(r),
			P(t, e, r)
		} (e, t) : function(e, t) {
			if (t) {
			...
			items: [{
				...
				function(e) {
					...
					if (a(o)) {
						...
						n.find("#vspace").value(""),
						n.find("#hspace").value(""),
						((i = O(i))["margin-top"] && i["margin-bottom"] || i["margin-right"] && i["margin-left"]) && (i["margin-top"] === i["margin-bottom"] ? n.find("#vspace").value(_(i["margin-top"])) : n.find("#vspace").value(""), i["margin-right"] === i["margin-left"] ? n.find("#hspace").value(_(i["margin-right"])) : n.find("#hspace").value("")),
						i["border-width"] ? n.find("#border").value(_(i["border-width"])) : n.find("#border").value(""),
						i["border-style"] ? n.find("#borderStyle").value(i["border-style"]) : n.find("#borderStyle").value(""),
						n.find("#style").value(t.serializeStyle(t.parseStyle(t.serializeStyle(i))))
					}
				})
			},
			{
	...
	ve = function(e, t, n) {
		...
		o = e.value(),
		a = t.value();
		n && r && i && o && a && (o !== r ? (a = Math.round(o / r * a), isNaN(a) || t.value(a)) : (o = Math.round(a / i * o), isNaN(o) || e.value(o))),
		pe(e, t)
	},
	be = function(e) {
		he(e, ve)
	...
	Ne = function(s, e) {
		var t = [{
			...
			onchange: function(e) {
				...
				a.width || a.height || (r = n.convertURL(l.value(), "src"), i = f(n), o = new RegExp("^(?:[a-z]+:)?//", "i"), i && !o.test(r) && r.substring(0, i.length) !== i && (r = i + r), l.value(r), C(n.documentBaseURI.toAbsolute(l.value()),
				function(e) {
					e.width && e.height && d(n) && (u.find("#width").value(e.width), u.find("#height").value(e.height), xe(u))
				}))
			},
			onbeforecall: Se
		},
	...
	function Le(a) {
		var t = function(e, r, i, t) {
			var o, n; (o = new Pe).open("POST", a.url),
			...
			o.onload = function() {
				var e, t, n;
				o.status < 200 || 300 <= o.status ? i("HTTP Error: " + o.status) : (e = JSON.parse(o.responseText)) && "string" == typeof e.location ? r((t = a.basePath, n = e.location, t ? t.replace(/\/$/, "") + "/" + n.replace(/^\//, "") : n)) : i("Invalid JSON: " + o.responseText)
			},
		...
		{
			upload: function(e) {
				return a.url || a.handler !== t ? (r = e, i = a.handler, new x(function(e, t) {
					try {
						i(r, e, t, Ie)
					} catch(n) {
						t(n.message)
	...
	function ze(o) {
		function e(e) {
			...
			if (e && (t = {
				...
				onselect: function(e) {
					var t = n.find("#alt"); (!t.value() || e.lastControl && t.value() === e.lastControl.text()) && t.value(e.control.text()),
	...
	He = function(o) {
		return function(e) {
			...
			(n = t.attr("class")) && /\bimage\b/.test(n) && (t.attr("contenteditable", o ? "false": null), w.each(t.getAll("figcaption"), i))
		}
	},
	Fe = function(e) {
		e.on("preInit",
