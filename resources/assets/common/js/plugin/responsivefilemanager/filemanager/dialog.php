...
<script src="js/jquery-ui.min.js"></script>
	...
	<?php }else{ ?>
		<script src="js/editorjs/editor1.js"></script>
	<?php }} ?>
...
<script src="js/JavaScript-Load-Image/load-image.all.min.js"></script>
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
<script src="js/JavaScript-Canvas-to-Blob/canvas-to-blob.min.js"></script>
	...
	<div class="navbar-inner">
		...
		<div class="filters">
			...
			<div class="span6 entire types">
				...
				<label id="ff-item-type-all" title="<?php echo trans('All');?>" <?php if($_GET['type']==1 || $_GET['type']==3){ ?>style="visibility: hidden;" <?php } ?> data-item="ff-item-type-all" for="select-type-all" style="margin-rigth:0px;" class="tip btn btn-inverse ff-label-type-all"><i class="icon-book icon-white"></i></label>
